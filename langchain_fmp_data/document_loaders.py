...
class FmpDataLoader(BaseLoader):
    ...
    """
    FmpData document loader integration
    ...
    Instantiate:
        .. code-block:: python
            ...
            from langchain_community.document_loaders import FmpDataLoader
