...
class ChatFmpData(BaseChatModel):
    ...
    """FmpData chat model integration.
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            FmpData API key. If not passed in will be read from env var FMPDATA_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatFmpData.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatFmpData.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatFmpData supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatFmpData supports async generation. Otherwise delete.
